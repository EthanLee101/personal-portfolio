...
const Portfolio = () => {
  ...
  const ProjectModal = React.memo(({ project, onClose, isMobile }) => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-75 backdrop-blur-sm" onClick={onClose}>
        <div className="bg-slate-800 rounded-2xl max-w-6xl w-full h-[85vh] flex flex-col overflow-hidden shadow-2xl border border-slate-700" onClick={(e) => e.stopPropagation()}>
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-6 border-b border-slate-700 flex-shrink-0">
            <div className="flex justify-between items-start">
              <div>
                <h2 className="text-2xl font-bold mb-2 text-teal-400">{modalContent.title}</h2>
                <p className="text-slate-400">{modalContent.description}</p>
              </div>
              <button
                onClick={onClose}
                className="text-slate-400 hover:text-white transition-colors hover:rotate-90 transform duration-300 flex-shrink-0 p-2"
              >
                <X size={24} />
              </button>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6 h-full">
              <div className="lg:col-span-1 flex flex-col h-full overflow-hidden">
                <div className="overflow-y-auto flex-1">
                  <h3 className="text-lg font-semibold mb-4 text-teal-400">Key Features</h3>
                  ...
                  <h3 className="text-lg font-semibold mb-4 text-teal-400">Technologies</h3>
                  <div className="flex flex-wrap gap-2 mb-6">
                    {modalContent.tech.map((tech) => (
                      <span key={tech} className="text-xs bg-slate-700 text-slate-300 px-3 py-1 rounded-full border border-slate-600">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <div className="space-y-3 flex-shrink-0">
                  <a
                    ...
                    className="flex items-center justify-center bg-slate-700 hover:bg-slate-600 text-white px-4 py-3 rounded-lg transition-all duration-200 text-sm font-medium"
                  >
                  ...
                  {modalContent.demo && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center bg-teal-600 hover:bg-teal-700 text-white px-4 py-3 rounded-lg transition-all duration-200 text-sm font-medium"
                    >
              ...
              <div className="lg:col-span-2 h-full flex flex-col">
                <div className="bg-slate-900 rounded-xl border border-slate-700 flex flex-col h-full overflow-hidden">
                  <div className="flex items-center justify-between p-4 border-b border-slate-700 flex-shrink-0">
                    {isMobile ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between w-full text-sm text-slate-400 hover:text-teal-400 transition-colors cursor-pointer group"
                      >
                        <span>
                        ...
                        <div className="flex items-center gap-2">
                          <ExternalLink className="text-teal-400 group-hover:text-teal-300 transition-colors" size={16} />
                          {modalContent.contentType === 'demo' && <Play className="text-teal-400 group-hover:text-teal-300 transition-colors" size={18} />}
                          {modalContent.contentType === 'slides' && <FileText className="text-teal-400 group-hover:text-teal-300 transition-colors" size={18} />}
                        </div>
                      </a>
                    ) : (
                      <>
                        ...
                        {modalContent.contentType === 'demo' && <Play className="text-teal-400" size={18} />}
                        {modalContent.contentType === 'slides' && <FileText className="text-teal-400" size={18} />}
                      </>
                    )}
                  </div>
  ...
  return (
    <div className="bg-slate-900 text-white overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
            <div className="text-center lg:text-left">
              <div className="mb-8">
                ...
                <h2 className="text-2xl lg:text-4xl text-slate-300 mb-8 font-light">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-8 mb-12 text-slate-400">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg">Available Summer 2026</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                <button
                  ...
                  className="bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white px-12 py-4 rounded-xl text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg shadow-teal-600/30"
                >
                  View My Work
                </button>
                <a
                  ...
                  className="border-2 border-slate-600 hover:border-teal-400 text-slate-300 hover:text-teal-400 px-12 py-4 rounded-xl text-lg font-medium transition-all duration-300 flex items-center justify-center gap-3 hover:scale-105"
                >
                  <Download size={20} />
                  Resume
                </a>
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                <div className="w-80 h-80 lg:w-[420px] lg:h-[420px] rounded-full overflow-hidden border-4 border-teal-400/30 shadow-2xl shadow-teal-400/20">
                  <img
                ...
                <div className="absolute -top-4 -right-4 w-32 h-32 bg-gradient-to-r from-teal-400/20 to-cyan-400/20 rounded-full animate-pulse"></div>
                <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-slate-600/30 rounded-full"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="h-screen flex items-center justify-center bg-slate-800 relative">
        <div className="max-w-7xl mx-auto px-8 h-full flex items-center">
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
            <div>
              ...
              <div className="space-y-6 text-lg lg:text-xl text-slate-300 leading-relaxed mb-10">
                <p>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="bg-slate-900/70 backdrop-blur p-6 rounded-2xl border border-slate-700/50 text-center">
                  <span className="text-3xl font-bold text-teal-400 block">300+</span>
                  <span className="text-slate-400 text-sm">Active Users</span>
                </div>
                <div className="bg-slate-900/70 backdrop-blur p-6 rounded-2xl border border-slate-700/50 text-center">
                  <span className="text-3xl font-bold text-teal-400 block">6</span>
                  <span className="text-slate-400 text-sm">Major Projects</span>
                </div>
                <div className="bg-slate-900/70 backdrop-blur p-6 rounded-2xl border border-slate-700/50 text-center">
                  <span className="text-3xl font-bold text-teal-400 block">3+</span>
            ...
            <div className="flex justify-center">
              <div className="bg-slate-900/50 backdrop-blur p-8 rounded-3xl border border-slate-700/50 shadow-2xl w-full max-w-md">
                <h3 className="text-2xl font-semibold mb-8 text-center">Current Focus</h3>
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    <div className="w-3 h-3 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-full"></div>
                    <span className="text-lg">Seeking Summer 2026 internships</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-3 h-3 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-full"></div>
                    <span className="text-lg">Building AI-powered applications</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-3 h-3 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-full"></div>
                    <span className="text-lg">Exploring machine learning</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-3 h-3 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-full"></div>
                    <span className="text-lg">Contributing to open source</span>
                  </div>
                </div>
                
                <div className="mt-8 pt-6 border-t border-slate-700">
                  <p className="text-slate-400 text-center mb-4">Let's connect:</p>
      ...
      <section className="min-h-screen py-20 flex items-center justify-center relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 h-full flex flex-col justify-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 flex-1 content-center">
            {projects.map((project, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur rounded-3xl overflow-hidden border border-slate-700/50 hover:border-teal-400/50 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl h-fit">
                ...
                <div className="p-5">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <Star className="text-teal-400" size={16} />
                      <h3 className="text-lg font-bold">{project.title}</h3>
                    </div>
                    <span className="text-xs bg-teal-600/20 text-teal-400 px-2 py-1 rounded-full border border-teal-400/30">
                      {project.category}
                    </span>
                  </div>
                  <p className="text-slate-400 mb-3 text-sm leading-relaxed">{project.description}</p>
                  ...
                  <div className="text-sm text-teal-400 font-medium mb-3 text-center bg-slate-900/30 py-2 px-3 rounded-lg">
                    {project.stats}
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex space-x-2">
                      ...
                      {project.demo && (
                        <a
                          href={project.demo}
                          className="flex items-center text-slate-400 hover:text-slate-300 text-sm font-medium transition-colors"
                        >
                    ...
                    {project.modalContent && (
                      <button
                        ...
                        className="flex items-center text-white text-xs bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 px-2 py-1 rounded-lg transition-all duration-300 font-medium"
                      >
      ...
      <section className="min-h-screen py-20 flex items-center justify-center bg-slate-800">
        <div className="max-w-6xl mx-auto px-8 h-full flex flex-col justify-center">
          <div className="text-center mb-12">
            <h2 className="text-5xl lg:text-6xl font-bold mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 flex-1 content-center">
            {skills.map((skillGroup, index) => (
              <div key={index} className="bg-slate-900/50 backdrop-blur p-6 rounded-3xl border border-slate-700/50 text-center hover:border-teal-400/50 transition-all duration-300 hover:scale-105 shadow-xl h-fit">
                <div className="text-teal-400 mb-6 flex justify-center">
                  {skillGroup.icon}
                </div>
                <h3 className="text-xl font-bold mb-6 text-teal-400">{skillGroup.category}</h3>
                <div className="space-y-3">
                  {skillGroup.items.map((skill) => (
                    <div key={skill} className="text-slate-300 py-2 px-4 bg-slate-800/70 rounded-xl text-sm font-medium border border-slate-700/30 hover:border-teal-400/30 transition-colors">
                      {skill}
                    </div>
                  ))}
                </div>
          ...
          <div className="text-center mt-12">
            ...
            <div className="flex justify-center gap-6 text-slate-500 text-sm">
              <span className="px-3 py-1 bg-slate-900/50 rounded-full">Rust</span>
              <span className="px-3 py-1 bg-slate-900/50 rounded-full">GraphQL</span>
              <span className="px-3 py-1 bg-slate-900/50 rounded-full">Kubernetes</span>
              <span className="px-3 py-1 bg-slate-900/50 rounded-full">WebAssembly</span>
            </div>
          </div>
        </div>
      </section>

      <section className="min-h-screen py-20 flex items-center justify-center bg-slate-900">
        <div className="max-w-7xl mx-auto px-8 h-full flex flex-col justify-center">
          <div className="text-center mb-12">
            <h2 className="text-5xl lg:text-6xl font-bold mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 flex-1 content-center">
            <div className="bg-slate-800/50 backdrop-blur p-6 rounded-3xl border border-slate-700/50 text-center hover:border-teal-400/50 transition-all duration-300 hover:scale-105 shadow-xl h-fit">
              <div className="text-teal-400 mb-6 flex justify-center">
                <Code className="w-8 h-8" />
              </div>
              <h3 className="text-xl font-bold mb-6 text-teal-400">Code Quality</h3>
              <div className="space-y-3">
                <div className="text-slate-300 py-2 px-4 bg-slate-900/70 rounded-xl text-sm font-medium border border-slate-700/30 hover:border-teal-400/30 transition-colors">
            ...
            <div className="bg-slate-800/50 backdrop-blur p-6 rounded-3xl border border-slate-700/50 text-center hover:border-teal-400/50 transition-all duration-300 hover:scale-105 shadow-xl h-fit">
              ...
              <h3 className="text-xl font-bold mb-6 text-teal-400">Testing & CI/CD</h3>
              <div className="space-y-3">
                <div className="text-slate-300 py-2 px-4 bg-slate-900/70 rounded-xl text-sm font-medium border border-slate-700/30 hover:border-teal-400/30 transition-colors">
            ...
            <div className="bg-slate-800/50 backdrop-blur p-6 rounded-3xl border border-slate-700/50 text-center hover:border-teal-400/50 transition-all duration-300 hover:scale-105 shadow-xl h-fit">
              ...
              <h3 className="text-xl font-bold mb-6 text-teal-400">Architecture & Scale</h3>
              <div className="space-y-3">
                <div className="text-slate-300 py-2 px-4 bg-slate-900/70 rounded-xl text-sm font-medium border border-slate-700/30 hover:border-teal-400/30 transition-colors">
                  RESTful API design
                </div>
          ...
          <div className="text-center mt-12">
            <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-8">
              <div className="bg-slate-800/50 backdrop-blur p-4 rounded-2xl border border-slate-700/50">
                <span className="text-2xl font-bold text-teal-400 block">85%</span>
                <span className="text-slate-400 text-sm">Avg Test Coverage</span>
              </div>
              <div className="bg-slate-800/50 backdrop-blur p-4 rounded-2xl border border-slate-700/50">
                <span className="text-2xl font-bold text-teal-400 block">99%</span>
                <span className="text-slate-400 text-sm">Uptime Achieved</span>
              </div>
              <div className="bg-slate-800/50 backdrop-blur p-4 rounded-2xl border border-slate-700/50">
                <span className="text-2xl font-bold text-teal-400 block">&lt;3s</span>
                <span className="text-slate-400 text-sm">Avg Load Time</span>
              </div>
              <div className="bg-slate-800/50 backdrop-blur p-4 rounded-2xl border border-slate-700/50">
                <span className="text-2xl font-bold text-teal-400 block">15+</span>
      ...
      <section className="min-h-screen py-20 flex items-center justify-center relative">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900/20"></div>
        <div className="relative z-10 max-w-4xl mx-auto px-8 h-full flex flex-col justify-center text-center">
          <h2 className="text-5xl lg:text-6xl font-bold mb-8">
            Let's <span className="text-transparent bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text">Connect</span>
          </h2>
          <p className="text-2xl lg:text-3xl text-slate-300 mb-16 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <a
              ...
              className="bg-slate-800/50 backdrop-blur p-8 rounded-3xl border border-slate-700/50 hover:border-teal-400/50 transition-all duration-300 hover:scale-105 group shadow-xl hover:shadow-2xl"
            >
              <div className="w-20 h-20 bg-gradient-to-r from-teal-600 to-cyan-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:from-teal-500 group-hover:to-cyan-500 transition-colors shadow-lg">
                <Mail size={32} />
              </div>
              <h3 className="text-xl font-semibold mb-3">Email</h3>
              <p className="text-slate-400">ethanplee24@gmail.com</p>
            </a>
            ...
            >
              ...
              <p className="text-slate-400">Code Portfolio</p>
            </a>
          </div>

          <div className="text-slate-400">
            <p className="mb-4 text-lg">© 2025 Ethan Lee • Built with React & Tailwind CSS</p>
            <p className="text-lg">Available for internship opportunities starting Summer 2026</p>
          </div>
        </div>
      </section>
